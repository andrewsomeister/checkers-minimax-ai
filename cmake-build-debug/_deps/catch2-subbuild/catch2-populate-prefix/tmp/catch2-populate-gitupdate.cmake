...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref v2.x
  WORKING_DIRECTORY "C:/Users/andre/OneDrive/Documents/Cinder/my-projects/checkers-final-project/cmake-build-debug/_deps/catch2-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.x")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.x")
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 v2.x
  WORKING_DIRECTORY "C:/Users/andre/OneDrive/Documents/Cinder/my-projects/checkers-final-project/cmake-build-debug/_deps/catch2-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/andre/OneDrive/Documents/Cinder/my-projects/checkers-final-project/cmake-build-debug/_deps/catch2-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/andre/OneDrive/Documents/Cinder/my-projects/checkers-final-project/cmake-build-debug/_deps/catch2-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
